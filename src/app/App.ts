...
export class App {
    ...
    mount = () => {
        ...
        voiceStart.addEventListener("click", (e: MouseEvent) => {
            this.pixiCanvas.playVoice(4, "建設業大手の腹黒(はらぐろ)建設が埼玉県内の土地の売買などをめぐって法人税数千万円を脱税した疑いが強まり、東京地検 特捜部などはきょう、群馬県高崎市の本社などを一斉に家宅捜索しました。", 1.75);
        ...
        voiceStop.addEventListener("click", (e: MouseEvent) => {
            ...
            this.pixiCanvas.hiyori.container.scale.set(2, 2);
        });
    };
}
